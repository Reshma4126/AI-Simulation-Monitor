...
def _run_pipeline_worker(job_id: str, file_path: Path, params: dict, is_audio: bool):
    ...
    try:
        ...
        from reporting.narrative_engine import NarrativeEngine
        from reporting.pdf_adapter import build_pdf_input
        from reporting.pdf_engine import generate_pdf
        from scoring.schemas.event_schema import FindingRecord, Severity
...
def scenario_report():
    ...
    try:
        from reporting.pdf_adapter import build_scenario_pdf_input
        from reporting.pdf_engine  import generate_pdf
