...
from analysis.scoring.schemas.event_schema import FindingRecord, TranscriptSegment, UnifiedTimeline
from analysis.scoring.score_models import DomainScore
